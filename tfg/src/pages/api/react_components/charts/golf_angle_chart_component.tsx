...
const ChartComponent: React.FC<ChartComponentProps> = ({
  ...
  useEffect(() => {
    ...
    console.log('juegoss golff', juegos);
    console.log('juegoName gold', juegoName);
...
const options = {
  ...
  return isLoading ? <div>Cargando...</div> : <Line className='w-4/5 h-[350px] mr-8 text-white' data={dataForChart} options={options} />;
};
